...
module.exports = function(model,config){	
    ...
    module.confirmBet = async function(request, res){
            ...
            inputs.regSelection =inputs.regSelection.replace(/\//g, "");
            inputs.bonusSelection = inputs.bonusSelection.replace(/\//g, "");
            inputs.balance = inputs.balance.replace(/\//g, "");
            inputs.winValue = inputs.winValue.replace(/\//g, "");
            inputs.stake_value = inputs.stake_value.replace(/\//g, "");
            ////////////////Block Iav Check////////////////////
