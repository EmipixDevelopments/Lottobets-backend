...
Sys.SqlPool.getConnection((err, connection) => {
    ...
    if (connection){
	    ...
	    //Sys.KioskServer.Common.Controllers.LiveApiController.bradcastFavouriteLoto();

		Sys.Server.listen(Sys.Config.Socket.port,function() {
		console.log("(---------------------------------------------------------------)");
		console.log(" |                    Server Started...                        |");
		console.log(" |                  http://"+Sys.Config.Database[Sys.Config.Database.connectionType].sql.host+":"+Sys.Config.Socket.port+"                      |");
		console.log("(---------------------------------------------------------------)");
		});
		connection.release()
	} 
